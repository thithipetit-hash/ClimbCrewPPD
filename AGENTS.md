...
- Toute saisie persistée ou action d'enregistrement doit produire un acquittement visuel explicite : état en cours si nécessaire, succès après confirmation serveur, erreur visible en cas d'échec.

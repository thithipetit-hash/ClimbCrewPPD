...
import { validateLegacyImportPayload } from "./validation.js";
import { createParticipantsRouter } from "./routes/participants.js";
import { createRealisationsRouter } from "./routes/realisations.js";
import { createSessionsRouter } from "./routes/sessions.js";
import { createVoiesRouter } from "./routes/voies.js";
...
// Les domaines métier sont isolés afin de limiter les régressions lors des évolutions.
app.use("/realisations", createRealisationsRouter({ pool, requireAuth }));
app.use(createVoiesRouter({ pool, requireAuth, requireAdmin }));
app.use("/participants", createParticipantsRouter({ pool, requireAuth, requireAdmin }));
